...
export default class List extends React.Component {
    render() {
        ...
        return (
            <ListContainer noupdate={true} updateQuery={true} listCout={listCout} url={url} columnID={typeInfo.columnID} dataListName={'dataList'} Ttype={this.props.Ttype} history={history} />
        )
    }
}
